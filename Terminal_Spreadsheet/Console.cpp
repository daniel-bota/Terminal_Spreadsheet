...
void Console::WriteW(const std::wstring& text)
{
...
void Console::MoveCursor(const Position& position)
{
...
void Console::MoveCursor(const Direction& direction, int positions)
{
	if (direction & Right)
	{
